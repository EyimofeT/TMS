...
import {
  create_user_task, get_user_task, get_all_user_tasks_by_project_id, update_user_task_status , update_user_task, delete_user_task, get_all_user_task
} from "./controller.js";
...
router.get("/", authcheck, get_all_user_task)
